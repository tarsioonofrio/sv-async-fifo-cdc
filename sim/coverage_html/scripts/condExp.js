    ...
    if (type === 'terms') { //get terms row data
        ...
        data.r.forEach(function (r) {
            ...
            if (((!data[CONDEXP_ITEM.BIMODAL]) && (!data[CONDEXP_ITEM.PATTERN_TYPE])) || ((!data[CONDEXP_ITEM.BIMODAL]) && (data[CONDEXP_ITEM.PATTERN_TYPE]))) {
                ...
                rowItems.cTo0 = r[CONDEXP_ITEM.EXT_FEC][INDEX.TO0][CONDEXP_ITEM.EXC_COM]; //exclusion comment if exist
                ...
                rowItems.cTo1 = r[CONDEXP_ITEM.EXT_FEC][INDEX.TO1][CONDEXP_ITEM.EXC_COM]; //exclusion comment if exist
    ...
    ceColumnDefs = [
        {
            ...
            cellClassRules: {
                'exclusion': function (params) {
                    return isCondExprExcluded(params);
                },
            },
    ...
    ce1ExtColumnDefs = [
        {
            ...
            cellRenderer: function(params) {
                params.data.c = params.data.cTo0;
        ...
        },
        {
            ...
            cellRenderer: function(params) {
                params.data.c = params.data.cTo1;
